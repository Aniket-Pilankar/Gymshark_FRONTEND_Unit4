...
async function getData() {
    ...
    try {
        let res = await fetch("https://gymshark-backend.onrender.com/catogory/womens");
...
function sendIdToInsidePage(id) {
    // console.log('id:', id)
    localStorage.setItem('IdForSinglePageProductWomen', JSON.stringify(id));
    window.location.href = "insidepageWomen.html";
}